...
train <- read.csv("kaggle\\Titanic 1\\train.csv")
test <- read.csv("kaggle\\Titanic 1\\test.csv")
...
train <- missForest(train, maxiter = 10, ntree=1000, verbose=T)$ximp
test <- missForest(test, maxiter = 10, ntree=1000, verbose=T)$ximp
